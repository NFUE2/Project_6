...
public class NetworkManager : PunSingleton<NetworkManager>
{
    ...
    {
        UIManager.instance.Open<NetworkPanelUI>().Open(connectRoomMessage, false);
        PhotonNetwork.JoinRoom(room);
    }

    public IEnumerator Enter(string message, ClientState targetState, Func<bool> func)
    {
        if (!func()) yield break; //코루틴 종료

        UIManager.instance.Open<NetworkPanelUI>().Open(message, false);
        ...
        UIManager.instance.Open<NetworkPanelUI>().Close();
